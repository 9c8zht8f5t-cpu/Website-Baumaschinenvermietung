...
export const metadata: Metadata = {
  ...
  openGraph: { title: `${SITE.name} – Baumaschinen mieten`, type: "website", url: "https://" + SITE.domain },
};
...
<Header />
  ...
  <p className="mt-2">&copy; {new Date().getFullYear()} Mietservice Digitalsanierung</p>
</footer>
